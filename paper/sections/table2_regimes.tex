\begin{table}[t]
  ...
  \begin{tabular}{@{}lrr@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{The two sources, at the scales actually analysed. Mooncake figures are
  conversation / toolagent, the order used in every other table here; an earlier revision listed the
  request counts in the opposite order without labels. Descriptive statistics are
