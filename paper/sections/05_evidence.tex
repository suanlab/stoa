...
Two independent repairs of that bug disagree by 19 points. We report the repaired column in
\Cref{sec:reaction} as a band rather than a point estimate, and state the conclusion only at the
coarseness the band supports.
