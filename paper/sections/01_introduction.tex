...
\begin{itemize}
  ...
  \item \textbf{(C6)} A reusable evaluation protocol: eighteen measurement defects that each manufactured
  a plausible result here, grouped into seven mechanisms, and the cheap controls that catch them ---
