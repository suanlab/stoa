...
\begin{itemize}
  ...
  \item \textbf{(C6)} A reusable evaluation protocol: fifteen measurement defects that each manufactured
  a plausible result here, grouped into five mechanisms, and the cheap controls that catch them ---
