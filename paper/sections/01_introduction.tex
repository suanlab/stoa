...
blocks carry \textbf{95\% of the oracle's advantage}. A policy confined to the remaining 5\% looks flat
...
\begin{itemize}
  ...
  makes 95\% of a hindsight oracle's advantage unreachable, because 45--46\% of blocks do not exist yet
  ...
  \item \textbf{(C6)} A reusable evaluation protocol: nineteen measurement defects that each manufactured
  a plausible result here, grouped into eight mechanisms, and the cheap controls that catch them ---
